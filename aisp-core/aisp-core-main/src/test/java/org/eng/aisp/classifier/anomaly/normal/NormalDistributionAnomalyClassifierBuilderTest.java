...
public class NormalDistributionAnomalyClassifierBuilderTest extends AbstractClassifierBuilderTest {


	@Override
	protected IClassifierBuilder getBuilder() {
		return new NormalDistributionAnomalyClassifierBuilder();
	}

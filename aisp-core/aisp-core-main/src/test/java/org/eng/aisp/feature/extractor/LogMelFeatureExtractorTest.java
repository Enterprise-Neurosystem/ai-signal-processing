...
public class LogMelFeatureExtractorTest extends AbstractFeatureExtractorTest {

	@Override
	protected IFeatureExtractor<double[], double[]> getFeatureExtractor() {
		return new LogMelFeatureExtractor();
	}

	@Override
	protected IFeatureExtractor<double[], double[]> getFeatureExtractor(int samplingRate, int minHz, int maxHz, int featureLen) {
		return new LogMelFeatureExtractor(samplingRate, featureLen, minHz, maxHz, featureLen);
	}
}

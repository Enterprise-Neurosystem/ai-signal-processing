...
@RunWith(Suite.class)
@Suite.SuiteClasses({
	IdentityFeatureExtractorTest.class,
	FFTFeatureExtractorTest.class,
	MFCCFeatureExtractorTest.class,
	MFFBFeatureExtractorTest.class,
	LogMelFeatureExtractorTest.class
	})

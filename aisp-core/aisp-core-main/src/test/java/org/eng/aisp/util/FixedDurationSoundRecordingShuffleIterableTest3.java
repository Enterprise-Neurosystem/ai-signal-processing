...
public class FixedDurationSoundRecordingShuffleIterableTest3 extends AbstractLabeledWindowShuffleIterableTest {
	...
	protected IShuffleIterable<SoundRecording> getLabeledWindowShuffleIterable(String trainingLabel, IShuffleIterable<SoundRecording> iter, int count) {
		return new FixedDurationSoundRecordingShuffleIterable(iter, 500, PadType.ZeroPad);
	}

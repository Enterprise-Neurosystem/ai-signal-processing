...
public class EuclideanDistanceMergeKNNModelerTest extends AbstractKNNModelerTest {

//	@Override
//	protected IFixableClassifier<double[]> getClassifier() {
////		return new EuclidianDistanceMergeKNNClassifier(trainingLabel, 3, true, 100, false);
//		return new EuclidianDistanceMergeKNNClassifier();
//	}
//	
	@Override
	protected IFixableClassifier<double[]> getClassifier() throws AISPException {
//		IClassifierBuilder<double[],double[]> b = new EuclidianDistanceMergeKNNClassifierBuilder().setEnableOutlierDetection(false);
		// This can be used when running testMixingSoundParameters() with varying sampling rates, which should pass, but do not.

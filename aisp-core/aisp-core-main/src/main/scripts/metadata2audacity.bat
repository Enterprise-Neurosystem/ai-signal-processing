...
REM The name of the file relative to the AISP_HOME directory
set PYFILE=python\tools\metadata2audacity.py
...
:homeset
if NOT [%PYTHON%] == [] goto pythonset
set PYTHON=python
:pythonset
REM Do the actual work!
%PYTHON% %AISP_HOME%\%PYFILE% %*

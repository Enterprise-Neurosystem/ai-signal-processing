 ...
 *
 */
public class L1DistanceFunction implements IDistanceFunction<double[]> {

	private static final long serialVersionUID = 5807463933845520740L;

	@Override
	public double distance(double[] d1, double[] d2) {
		return VectorUtils.l1Distance(d1, d2);
	}

	@Override
	public double distance(double[] d1) {
		return VectorUtils.l1Distance(d1, null);
	}
	...
	public boolean equals(Object o) {
		...
		return o instanceof L1DistanceFunction;
	}

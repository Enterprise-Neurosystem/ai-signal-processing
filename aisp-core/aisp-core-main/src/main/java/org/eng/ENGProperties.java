 ...
 *
 */
public class ENGProperties extends ComponentProperties {

	private static ENGProperties instance = null;
	
	static {
		instance = new ENGProperties();
//		Initialize();
	}
	 ...
	 * @return
	 */
	public static ENGProperties instance() {

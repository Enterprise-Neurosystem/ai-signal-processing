 ...
 *
 */
public class ENGLogger  extends ComponentLogger {
	

	
	public final static String ROOT_LOGGER_NAME = "org.eng";
	
	public final static ENGLogger logger = new ENGLogger(ROOT_LOGGER_NAME, true);
	

	
	private ENGLogger(String name, boolean isRoot) {
		super(name,isRoot);
	}
	
	protected ComponentProperties getLoggerConfigProps() {
		return ENGProperties.instance();
	}
}
